...
(function () {
    ...
    var loadPackage = function (metadata) {
        ...
        var PACKAGE_NAME = "output/orbslam.data";
        var REMOTE_PACKAGE_BASE = "orbslam.data";
        ...
        function runWithFS() {
            ...
            function processPackageData(arrayBuffer) {
                ...
                Module["removeRunDependency"]("datafile_output/orbslam.data")
            }

            Module["addRunDependency"]("datafile_output/orbslam.data");
    ...
    loadPackage({
        "files": [{"filename": "/res/ORBvoc.bin", "start": 0, "end": 44365017}, {
            "filename": "/res/TUM1.yaml",
            "start": 44365017,
            "end": 44367607
        }], "remote_package_size": 44367607
    })
})();
...
var PThread = {
    unusedWorkers: [], runningWorkers: [], tlsInitFunctions: [], pthreads: {}, init: function () {
        ...
        var pthreadMainJs = locateFile("orbslam.worker.js");
...
function ___emscripten_thread_cleanup(thread) {
    if (!ENVIRONMENT_IS_PTHREAD) cleanupThread(thread); else postMessage({"cmd": "cleanupThread", "thread": thread})
}
...
var __ZN5boost13serialization16singleton_module8get_lockEv = Module["__ZN5boost13serialization16singleton_module8get_lockEv"] = createExportWrapper("_ZN5boost13serialization16singleton_module8get_lockEv");
var _track = Module["_track"] = createExportWrapper("track");
var _resetTrack = Module["_resetTrack"] = createExportWrapper("resetTrack");
